...
setup_multi_user() {
    ...
    bash <(curl -sL https://raw.githubusercontent.com/ZSVPD/Snell_Script/main/multi-user.sh)
...
setup_bbr() {
    ...
    bash <(curl -sL https://raw.githubusercontent.com/ZSVPD/Snell_Script/main/bbr.sh)
...
setup_shadowtls() {
    ...
    bash <(curl -sL https://raw.githubusercontent.com/ZSVPD/Snell_Script/main/shadowtls.sh)
